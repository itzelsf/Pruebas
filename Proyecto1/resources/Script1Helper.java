 ...
 * Generated     : <b>2018/07/18 15:45:26</b><br>
...
public abstract class Script1Helper extends RationalTestScript
{
	...
	/**
	 * SimilarSelections: with default state.
	 *		.captionText : Similar Selections
	 * 		.class : RelatedItemsDialog
	 * 		.processName : javaw.exe
	 */
	protected TopLevelTestObject similarSelections() 
	{
		return new TopLevelTestObject(
                        getMappedTestObject("similarSelections"));
	}
	/**
	 * SimilarSelections: with specific test context and state.
	 *		.captionText : Similar Selections
	 * 		.class : RelatedItemsDialog
	 * 		.processName : javaw.exe
	 */
	protected TopLevelTestObject similarSelections(TestObject anchor, long flags) 
	{
		return new TopLevelTestObject(
                        getMappedTestObject("similarSelections"), anchor, flags);
	}
